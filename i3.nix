...
# Pin workspaces to outputs (left/right).
set $left DP-2
set $right DP-1
...
bindsym $mod+Shift+v exec google-chrome-stable --proxy-server="socks5://macos:1080" --user-data-dir=~/.tmp/voxygen-proxy-chrome-profile
