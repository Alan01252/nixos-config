...
in
  buildVscodeMarketplaceExtension {
    ...
    postInstall = ''
      mkdir -p $out/share/vscode/extensions/ms-dotnettools.csharp/.omnisharp/1.37.16/
      touch $out/share/vscode/extensions/ms-dotnettools.csharp/.omnisharp/1.37.16/install.Lock
